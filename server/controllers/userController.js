...
export const register = async (req, res) => {
    try{
        ...
        const existingUser = await db.query('SELECT user_id, email, username FROM users WHERE email = ? OR username = ?', [email, username]);
        ...
        const newUser = await db.query('SELECT user_id, username, first_name, last_name, email FROM users WHERE user_id = ?', [userId]);
...
export const login = async (req, res) => {
    try{
        ...
        const result = await db.query('SELECT user_id, username, first_name, last_name, email, password FROM users WHERE email = ?', [email]);
...
export const checkUser = async (req, res) => {
    try {
        ...
        const result = await db.query('SELECT user_id, username, first_name, last_name, email FROM users WHERE user_id = ?', [userId]);
