...
export const questionsAPI = {
  ...
  postQuestion: (questionData) =>
    axiosInstance.post("/questions", questionData),
...
export const profileAPI = {
  ...
  updateProfile: (profileData) => axiosInstance.put("/profile/me", profileData),
  getProfileByUserId: (userId) => axiosInstance.get(`/profile/user/${userId}`),
};
