              ...
              <div className={styles.header}>
                ...
                {userInfo && (
                  <p className={styles.subtitle}>
                    Hi {userInfo.username}! Create a strong new password for
                    your account.
                  </p>
                )}
              </div>
              ...
              {!resetSuccess && (
                <Form onSubmit={handleSubmit}>
                  ...
                  <div className={styles.requirements}>
                    ...
                    <ul>
                      <li
                        className={passwordValue.length >= 8 ? styles.met : ""}
                      >
                        At least 8 characters
                      </li>
                      <li
                        className={
                          /[A-Z]/.test(passwordValue) ? styles.met : ""
                        }
                      >
                      ...
                      <li
                        className={/\d/.test(passwordValue) ? styles.met : ""}
                      >
                        One number
                      </li>
                      <li
