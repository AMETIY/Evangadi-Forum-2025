          ...
          <div className={styles.questionContent}>
            ...
            <div className={styles.questionMeta}>
              ...
              <span className={styles.questionDate}>
                {questionData.time && new Date(questionData.time).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'short',
                  day: 'numeric',
                  hour: '2-digit',
                ...
                <div className={styles.answerHeader}>
                  ...
                  <div className={styles.answerUserInfo}>
                    <span className={`${styles.username} ${
                      answer.username === questionData.username ? styles.questionAuthor : ''
                    }`}>
                      {answer.username}
                      {answer.username === questionData.username && (
                        <span className={styles.authorBadge}>Question Author</span>
                      )}
                    </span>
                  </div>
                </div>
