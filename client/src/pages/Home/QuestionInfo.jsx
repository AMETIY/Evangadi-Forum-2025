...
const QuestionInfo = ({username, title, questionId, userId, onQuestionDeleted }) => {
  ...
  const handleConfirmDelete = async () => {
    try{
      ...
      const errorMessage = err.response?.data?.error || 'Failed to delete question. Please try again.';
