...
export const AuthProvider = ({ children }) => {
      ...
      if (storedToken && storedUser) {
        try {
          ...
          if (res.data.success) {
            ...
            console.warn("Server rejected token during auth check"); 
          ...
          if (
            ...
            console.warn(
              "Network error during auth check, keeping user logged in locally"
            );
          }
        }
      }
  ...
  const logout = useCallback(() => {
    //remembering logout so that it doesn't get recreated very render
